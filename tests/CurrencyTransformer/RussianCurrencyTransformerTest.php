...
class RussianCurrencyTransformerTest extends CurrencyTransformerTest
{
    ...
    public function providerItConvertsMoneyAmountToWords(): array
    {
        return [
            ...
            [100, 'MXN', 'один мексиканский песо'],
            [200, 'MXN', 'два мексиканских песо'],
            [500, 'MXN', 'пять мексиканских песо'],
            [150, 'MXN', 'один мексиканский песо пятьдесят сентаво'],
            [201, 'MXN', 'два мексиканских песо один сентаво'],
        ];
    }
}
